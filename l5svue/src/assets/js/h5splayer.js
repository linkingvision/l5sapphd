...
{         alert(msg)
	...
	try {
        ...
        alert('4'+msg)
		this.pc.addIceCandidate(candidate
			, function()      {/*console.log ("[CFE] addIceCandidate OK");*/  alert('5'+msg)}
			, function(error) {console.log ("[CFE] addIceCandidate error:" + JSON.stringify(error));  alert('6'+msg)} );
 ...
 * Connect a websocket Stream to videoElement 
*/
H5sRTCPush.prototype.connect = function(videoin, codec, bitrate, resolution, audioin) {
	/* start connect to server */
	this._videoin = videoin;
	this._codec = codec;
